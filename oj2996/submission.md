...
```text
โจทย์นี้ให้รับstr 5 ตัว เเล้วให้่เรียงสลับ

Input:
รับ string 5 ตัว

Output:
ให้่เเสดงค่าออกมาเเล้วกลับตัวอักษร จึงใช้[::-1]

Constraints:
outputที่ออกมาต้องเป็นตัวพิมพ์เล็กเท่านั้น
```
...
```text
Step 1: รับค่า string x
Step 2: นำ x มา .lower() เพื่อทำให้เป็นตัวเล็ก
Step 3: นำ x มา[::-1] เพื่อให้กลับตัวอักษร
Step 4: เเสดงค่า x
```
