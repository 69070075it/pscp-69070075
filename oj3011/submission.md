...
```text
โจทย์ให้ผสมสี โดยต้องใช้เเค่เเม่สีผสมเท่านั้น

Input:
รับค่าสี 2 สี เป็นstring

Output:
เเสดงสีที่ผสมเเล้ว

Constraints:
ระวังสีที่ไม่ใช่เเม่สี ต้องให้เป็น error
```
...
```text
Step 1: รับstring 2 ค่า
Step 2: กำหนด list clr โดย ให้ใน list มีสีที่ต้องการ ( เเม่สี )
Step 3: หากไม่ใ่ช่สีที่กำหนดเเสดงผล error 
Step 4: หากเป็นสีที่กำหนด ใช้ if else เพื่อกำหนดการผสมสี
Step 5: เเสดงค่าสีที่ผสมได้
```
...
```text
ลองให้มีสีที่ไม่ได้กำหนดใน list
```
