...
Input:
รับค่า integer เป็นเงินที่นำมาคิด

Output:
เงินที่ต้องจ่ายคิดรวม vat 7% เเละรวมค่าservice

Constraints:
โจทย์ต้องการทศนิยม 2 ตำเเหน่ง , ต้องใช้ if else ให้ถูกตำเเหน่ง
```
...
```text
Step 1: รับค่า integer x เป็นเงินเเรก
Step 2: คำนวณค่า service 10% จากค่า x 
Step 3: โดยถ้า service < 50 ให้ service = 50 เเละคำนวณ vat 7% เเละหาผลรวม
Step 4: โดยถ้า service > 1000 ให้ service = 1000 เเละคำนวณ vat 7% เเละหาผลรวม
Step 5: โดยถ้านอกเหนือจากนี้ ก็คิด service ตาม step2 เเละคำนวณ vat 7% เเละหาผลรวม
Step 6: เเสดง output ตามเเต่ละเงื่อนไข
```
...
```text
ให้นอกเหนือเงื่อนไข เพื่อคำนวณ service ที่ได้
```
