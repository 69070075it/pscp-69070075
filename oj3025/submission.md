...
```text
โจทย์ให้หาว่าถ้าเดือนนี้ จะมีฤดูไหน

Input:
รับ 2 ค่า เดือน เเละวันที่

Output:
เเสดงเป็นฤดูกาลนั้นๆ

Constraints:
ต้องระวังโดยที่ทุกวันที่ 21 ของเดือนที่ 3 หารลงตัว จะเปลี่ยนฤดู
```
...
```text
Step 1: รับค่า 2 ตัว
Step 2: ใช้ if elseเพื่อกำหนดเงื่อนไข
Step 3: ใช้ in มาร่วมในเเต่ละ if else เพื่อกำหนดในเเต่ละเดือนนั้นๆ
Step 4: ใช้เงื่อนไขซ้อนเงื่อนไข เพื่อกำหนดว่าหลังวันที่ 21 ของเดือนที่ 3 หารลงตัว จะเปลี่ยนฤดู
Step 5: เเสดงผลตามเงื่ิอนไขนั้นๆ
```
...
```text
ลองกำหนดเดือนปกติ วันปกติ เพื่อเช็คว่าเพี้ยนมั้ย
```
...
```text
ลองเดือนปกติ เเต่วันที่เป็นวันหลังจากวันที่ 21
```
...
```text
ลองเดือนที่ 3 หารลงตัว เเละวันหลังวันที่ 21
```
